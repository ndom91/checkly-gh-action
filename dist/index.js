...
const yamlLint = __webpack_require__(864)
const fetch = __webpack_require__(493)
...
module.exports = global.fetch = global.fetch || (
	typeof process=='undefined' ? r(__webpack_require__(970)) : (function(url, opts) {
		return r(__webpack_require__(467))(String(url).replace(/^\/\//g,'https://'), opts);
	})
);
...
const merge = __webpack_require__(247);
